  ...
  return (
    <div className="p-3 mx-2 my-2 max-w-sm rounded-xl border border-gray-200 shadow-md hover:bg-gray-100 dark:hover:bg-gray-600">
      ...
      <div className="text-center">
        <Link to={`/edit-post/${id}`}><button type="button" className="mx-2 focus:outline-none text-white bg-purple-500 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Edit</button></Link>
