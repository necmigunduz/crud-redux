  ...
  return (
    <div className="p-3 mx-2 my-2 max-w-sm rounded-xl border border-gray-200 shadow-md hover:bg-gray-100 dark:hover:bg-gray-600">
      ...
      <div className="text-center">
        ...
        <button type="button" className="mx-2 focus:outline-none text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</button>
      </div>
    </div>
  );
};
